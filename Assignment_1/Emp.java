...
public static void main(String arg[])
{
          ...
          emp1.setter(1,"A","Manager","Mumbai",105000.00);

          Employee emp2 = new Employee();
          emp2.setter(2,"B","Manager","Bangalore",105000.00);

          Employee emp3 = new Employee();
          emp3.setter(3,"C","Assistant","Punjab",80000.00);

          Employee emp4 = new Employee();
          emp4.setter(4,"D","Manager","Delhi",155000.00);

          Employee emp5 = new Employee();
          emp5.setter(5,"E","Engineer","Hydrabad",200000.00);

          Employee emp6 = new Employee();
          emp6.setter(6,"F","Junior","Mumbai",40000.00);

          Employee emp7 = new Employee();
          emp7.setter(7,"G","SeniorEng","Bangalore",45000.00);

          Employee emp8 = new Employee();
          emp8.setter(8,"H","Manager","Delhi",165000.00);

          Employee emp9 = new Employee();
          emp9.setter(9,"I","Reseacher","Mysore",205000.00);

          Employee emp10 = new Employee();
          emp10.setter(10,"J","Manager","Hydrabad",12500.00);
